import { getScheduleOfPT } from "@/services/admin/Schedule";
import { useEffect, useState } from "react";

export default function PTScheduleTab({ ptId }) {
  ...
  useEffect(() => {
    const fetchSchedules = async () => {
      try {
        setLoading(true);
        const res = await getScheduleOfPT(ptId);
