        ...
        <div className="bg-gray-50 p-6 md:p-8 min-h-screen">
            ...
            <div className="flex items-center justify-center gap-6 mb-8 flex-wrap">
                <button
                    onClick={prevWeek}
                    disabled={isLoading}
                    className="px-4 py-2 bg-purple-700 text-white rounded-lg hover:bg-purple-800 cursor-pointer disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
                >
                    ← Tuần trước
                </button>
