      ...
      <div className="w-full min-h-screen bg-gray-50 flex items-center justify-center px-6 py-12">
        <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex flex-col">
            <h2 className="text-4xl font-extrabold mb-4 text-purple-800">
              TÍNH BMI (CHỈ SỐ KHỐI CƠ THỂ)
            </h2>

            <p className="text-gray-700 mb-8 leading-relaxed">
              Đo chỉ số BMI để đánh giá mức độ béo, gầy hay cân nặng lý tưởng.
              Chỉ số BMI giúp theo dõi tình trạng cơ thể trong quá trình tập
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  />
                  {errors.height && (
                    <p className="text-red-500 mt-1">{errors.height.message}</p>
                  )}
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  <>
                    <div
                      key={idx}
                      className="border-r border-gray-300 py-2 text-center font-medium text-gray-600"
                    >
                      {item.range}
                    </div>
                    <div
                      key={idx + "s"}
                      className="text-center py-2 text-gray-700 font-semibold"
                    >
                      {item.status}
                    </div>
                  </>
            ...
            <div className="bg-white rounded-3xl shadow-lg p-6 transform transition hover:scale-105">
              ...
              <div className="border border-purple-200 bg-purple-50 p-6 rounded-2xl text-center text-2xl font-semibold text-purple-800 transform transition hover:scale-105">
                ...
                <span className="text-red-500 text-5xl ml-2">
                  {bmi?.toFixed(2)}
                </span>
              </div>
            </div>
